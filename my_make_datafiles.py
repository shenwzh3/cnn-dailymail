...
finished_files_dir = os.path.join(data_path, 'finished_files')
chunks_dir = os.path.join(finished_files_dir, "chunked")


all_train_urls = os.path.join(home_path, 'data/info/train_list.txt')
all_val_urls = os.path.join(home_path, 'data/info/valid_list.txt')
...
if __name__ == '__main__':
  ...
  dir_list = [d for d in  os.listdir(stories_dir) if '.txt' not in d]
